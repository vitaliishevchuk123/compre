...
export const A1_CARDS: LessonCard[] = [
  ...
  },
  {
    order: 400,
    category: 'adjectives',
    sentence: 'Which piece?',
    imageKey: 'a1/adj-last',
    options: ['last', 'first', 'next', 'free'],
    answer: 'last',
    answerPhrase: 'The last piece.',
    description: 'This word means the final one, with no more after it. If only one piece of cake is left on the plate, it is this piece. The person at the back of a queue is in this position.',
  },
  {
    order: 401,
    category: 'adjectives',
  ...
  },
  {
    ...
    answer: 'second',
    answerPhrase: 'The second car.',
    description: 'This word means number two. It comes right after the first one. When cars stand in a row on a street, it is the car after the first car.',
  },
  {
    order: 404,
    category: 'actions',
  ...
  },
  {
    order: 406,
    category: 'actions',
    sentence: 'What do the men do?',
    imageKey: 'a1/act-remember',
    options: ['remember', 'forget', 'ignore', 'wish'],
    answer: 'remember',
    answerPhrase: 'The men remember.',
    description: 'You do this when a memory from the past comes into your mind. You keep a name, a face, or a song in your head for a long time. Two friends do it when they sit together and think about the old days.',
  },
  {
    order: 407,
    category: 'actions',
  ...
  },
  {
    ...
    answer: 'change',
    answerPhrase: 'The man is changing direction.',
  ...
  },
  {
    ...
    options: ['move', 'stop', 'freeze', 'stay'],
    answer: 'move',
    answerPhrase: 'The friends are moving the sofa.',
    description: 'You do this when you change the position of something from one place to another. Friends do it when they take a sofa up the stairs to a new home. Nothing stays in the same place.',
  },
  {
    order: 415,
    category: 'actions',
  ...
  },
  {
    ...
    answer: 'catch',
    answerPhrase: 'The man is catching the ball.',
    description: 'You do this when something flies through the air, and you take it with your hands. A goalkeeper does it with a ball, and a man does it with a football in the street. You need quick hands.',
  },
  {
    order: 418,
    category: 'actions',
    ...
    answer: 'throw',
    answerPhrase: 'The boy is throwing the ball.',
    description: 'You do this when you send something through the air with a fast movement of your arm. You swing your arm and the ball leaves your hand. A father shows his son how to do it with a football in the park.',
  },
  {
    order: 419,
    category: 'actions',
    ...
    answer: 'pull',
    answerPhrase: 'The dog is pulling the rope.',
  ...
  },
  {
    order: 423,
    category: 'actions',
    sentence: 'What are the man and the woman doing?',
    imageKey: 'a1/act-kiss',
    options: ['kiss', 'shout', 'ignore', 'push'],
    answer: 'kiss',
    answerPhrase: 'The man and the woman are kissing.',
    description: 'You do this with your lips to show love. A mother does it to a baby, and a man and a woman do it when they love each other. It is a soft touch of the mouth on a cheek or on other lips.',
  },
  {
    order: 424,
    category: 'actions',
  ...
  },
  {
    ...
    answer: 'cry',
    answerPhrase: 'The man is crying.',
  ...
  },
  {
    order: 459,
    category: 'questions',
    sentence: 'A man has a big cake with candles. What do her friends ask?',
    imageKey: 'a1/q-how',
  ...
  },
  {
    order: 465,
    category: 'prepositions',
    sentence: 'Look at the street. Where is the restaurant in relation to the bank?',
    imageKey: 'a1/prep-next-to',
    options: ['next to', 'above', 'under', 'across'],
    answer: 'next to',
    answerPhrase: 'The restaurant is next to the bank.',
  ...
  },
  {
    order: 466,
    category: 'prepositions',
    sentence: 'The children wait outside the school. Where do they stand in relation to the school?',
